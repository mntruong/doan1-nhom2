    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <table class="table table-striped"> 
                ...
                <tbody>
                    <?php 
                        $query = "SELECT code_ship, name_customer, phone_customer,address_customer,order_day,code_bill,status_ship, tb_district.name_district, tb_city.name_city FROM tb_order,tb_bill,tb_ship, tb_district, tb_city WHERE tb_district.id_city = tb_city.id_city && tb_district.id_district = tb_order.id_district && tb_order.id_order = tb_bill.id_order && tb_bill.id_bill = tb_ship.id_bill &&  status_ship = '0' || status_ship = '2'  GROUP BY code_ship";
